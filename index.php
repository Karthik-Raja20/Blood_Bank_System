...
<body>
    ...
    <section id="header">
        <div class="container">
            ...
            <h1 style="color:white">We are seeking for a better community health.</h1>
            <h4 style="color:white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora repellat inventore nemo repudiandae
                ipsum quos.</h4>
            <button class="btn more" onclick= "window.location.href = './about.php';">More</button>
        </div>
    </section>
    <!-- Header End -->
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="btn-cont">
                                    <button class="card-btn" onclick= "window.location.href = 'artical.php';">Details</button>
                                </div>
                            </div>
                        </div>
                    </div>
